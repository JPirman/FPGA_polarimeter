...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sampling_controller is
  ...
  signal \cpos[6]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of bram_en_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cpos[0]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \cpos[6]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \cpos[9]_i_3\ : label is "soft_lutpair4";
...
\cpos[10]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00800040"
    )
        port map (
...
\cpos[10]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F7FFFFFF"
    )
        port map (
...
\cpos[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\cpos[6]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\cpos[9]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
