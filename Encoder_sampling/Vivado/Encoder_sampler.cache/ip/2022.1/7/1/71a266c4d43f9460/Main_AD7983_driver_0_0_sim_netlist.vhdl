...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AD7983_driver is
  ...
  signal \adc_next_state__1\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \adc_next_state_inferred__3/i__n_0\ : STD_LOGIC;
  signal \adc_next_state_reg[3]_i_2_n_0\ : STD_LOGIC;
  signal \adc_next_state_reg[3]_i_3_n_0\ : STD_LOGIC;
  signal \adc_next_state_reg[3]_i_4_n_0\ : STD_LOGIC;
  ...
  signal data_rd_ready_o_reg_i_1_n_0 : STD_LOGIC;
  signal data_rd_ready_o_reg_i_2_n_0 : STD_LOGIC;
  signal data_rd_ready_o_reg_i_3_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \adc_next_state_inferred__3/i_\ : label is "soft_lutpair2";
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of \adc_next_state_reg[0]\ : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP : string;
  attribute XILINX_TRANSFORM_PINMAP of \adc_next_state_reg[0]\ : label is "VCC:GE GND:CLR";
  attribute SOFT_HLUTNM of \adc_next_state_reg[0]_i_1\ : label is "soft_lutpair5";
  attribute XILINX_LEGACY_PRIM of \adc_next_state_reg[1]\ : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of \adc_next_state_reg[1]\ : label is "VCC:GE GND:CLR";
  attribute SOFT_HLUTNM of \adc_next_state_reg[1]_i_1\ : label is "soft_lutpair6";
  attribute XILINX_LEGACY_PRIM of \adc_next_state_reg[2]\ : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of \adc_next_state_reg[2]\ : label is "VCC:GE GND:CLR";
  attribute SOFT_HLUTNM of \adc_next_state_reg[2]_i_1\ : label is "soft_lutpair2";
  attribute XILINX_LEGACY_PRIM of \adc_next_state_reg[3]\ : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of \adc_next_state_reg[3]\ : label is "VCC:GE GND:CLR";
  attribute SOFT_HLUTNM of \adc_next_state_reg[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \adc_next_state_reg[3]_i_4\ : label is "soft_lutpair4";
  ...
  attribute XILINX_LEGACY_PRIM of data_rd_ready_o_reg : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of data_rd_ready_o_reg : label is "VCC:GE GND:CLR";
  attribute SOFT_HLUTNM of data_rd_ready_o_reg_i_3 : label is "soft_lutpair6";
...
\adc_next_state_inferred__3/i_\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0116"
    )
        port map (
      ...
      I2 => adc_state_reg(2),
      I3 => adc_state_reg(3),
      O => \adc_next_state_inferred__3/i__n_0\
    );
\adc_next_state_reg[0]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
      CLR => '0',
      D => \adc_next_state__1\(0),
      G => \adc_next_state_reg[3]_i_2_n_0\,
      GE => '1',
      Q => \adc_next_state__0\(0)
    );
\adc_next_state_reg[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEEB"
    )
        port map (
      ...
      I2 => adc_state_reg(1),
      I3 => adc_state_reg(2),
      O => \adc_next_state__1\(0)
    );
\adc_next_state_reg[1]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
      CLR => '0',
      D => \adc_next_state__1\(1),
      G => \adc_next_state_reg[3]_i_2_n_0\,
      GE => '1',
      Q => \adc_next_state__0\(1)
    );
\adc_next_state_reg[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
      ...
      I2 => adc_state_reg(2),
      I3 => adc_state_reg(1),
      O => \adc_next_state__1\(1)
    );
\adc_next_state_reg[2]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
      CLR => '0',
      D => \adc_next_state__1\(2),
      G => \adc_next_state_reg[3]_i_2_n_0\,
      GE => '1',
      Q => \adc_next_state__0\(2)
    );
\adc_next_state_reg[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0002"
    )
        port map (
      ...
      I2 => adc_state_reg(3),
      I3 => adc_state_reg(0),
      O => \adc_next_state__1\(2)
    );
\adc_next_state_reg[3]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
      CLR => '0',
      D => \adc_next_state__1\(3),
      G => \adc_next_state_reg[3]_i_2_n_0\,
      GE => '1',
      Q => \adc_next_state__0\(3)
    );
\adc_next_state_reg[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
      ...
      I2 => adc_state_reg(3),
      I3 => adc_state_reg(0),
      O => \adc_next_state__1\(3)
    );
\adc_next_state_reg[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFDDDDDFDD"
    )
        port map (
      I0 => \adc_next_state_inferred__3/i__n_0\,
      I1 => data_rd_ready_o_reg_i_2_n_0,
      I2 => adc_tcnv_cnt_reg(6),
      I3 => adc_state_reg(1),
      I4 => \adc_next_state_reg[3]_i_3_n_0\,
      I5 => \adc_next_state_reg[3]_i_4_n_0\,
      O => \adc_next_state_reg[3]_i_2_n_0\
    );
\adc_next_state_reg[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      O => \adc_next_state_reg[3]_i_3_n_0\
    );
\adc_next_state_reg[3]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF28"
    )
        port map (
      ...
      I2 => tg_prev_state,
      I3 => adc_state_reg(2),
      O => \adc_next_state_reg[3]_i_4_n_0\
    );
...
\adc_tcnv_cnt[6]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
        ...
        port map (
      I0 => \adc_next_state_reg[3]_i_3_n_0\,
...
data_rd_ready_o_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
      CLR => '0',
      D => adc_state_reg(3),
      G => data_rd_ready_o_reg_i_1_n_0,
      GE => '1',
      Q => data_rd_ready_o
    );
data_rd_ready_o_reg_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0022032203220022"
    )
        port map (
      I0 => data_rd_ready_o_reg_i_2_n_0,
      I1 => data_rd_ready_o_reg_i_3_n_0,
      I2 => adc_state_reg(3),
      I3 => adc_state_reg(0),
      I4 => tg_prev_state,
      I5 => trigg_i,
      O => data_rd_ready_o_reg_i_1_n_0
    );
data_rd_ready_o_reg_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => sclk_clk_cnt_reg(4),
      I5 => adc_state_reg(3),
      O => data_rd_ready_o_reg_i_2_n_0
    );
data_rd_ready_o_reg_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
