...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sampling_controller is
  ...
  signal \bram_wrdata[15]_i_2_n_0\ : STD_LOGIC;
...
\bram_wrdata[15]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\bram_wrdata[15]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00D0"
    )
        port map (
...
\bram_wrdata_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => fpga_clk_i,
      CE => \bram_wrdata[15]_i_2_n_0\,
      D => adc_data_1(0),
      Q => bram_wrdata(0),
      R => \bram_wrdata[15]_i_1_n_0\
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^bram_wrdata\ : STD_LOGIC_VECTOR ( 15 downto 0 );
...
begin
  ...
  cpos_o(9 downto 0) <= \^adc_data_1\(9 downto 0);
