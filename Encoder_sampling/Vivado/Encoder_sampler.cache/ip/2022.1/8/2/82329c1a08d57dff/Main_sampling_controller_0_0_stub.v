...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(fpga_clk_i, reset_n_i, data_ready_o, trigger_i, 
  bram_addr, bram_clk, bram_wrdata, bram_rddata, bram_en, bram_we, adc_data_ready_i, adc_data_i, 
  enc_cnt_i)
/* synthesis syn_black_box black_box_pad_pin="fpga_clk_i,reset_n_i,data_ready_o,trigger_i,bram_addr[10:0],bram_clk,bram_wrdata[15:0],bram_rddata[15:0],bram_en,bram_we,adc_data_ready_i,adc_data_i[15:0],enc_cnt_i[10:0]" */;
  input fpga_clk_i;
  input reset_n_i;
  output data_ready_o;
  input trigger_i;
