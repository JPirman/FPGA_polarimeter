...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sampling_controller is
  ...
  signal \cpos[10]_i_5_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \cpos[10]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \cpos[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cpos[5]_i_1\ : label is "soft_lutpair1";
...
\cpos[10]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\cpos[10]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
begin
  ...
  bram_addr(12) <= \<const0>\;
  bram_addr(11) <= \<const0>\;
  bram_addr(10 downto 0) <= \^bram_wrdata\(10 downto 0);
  bram_clk <= \^fpga_clk_i\;
  bram_en <= \<const1>\;
  bram_we(3) <= \^bram_we\(2);
  bram_we(2) <= \^bram_we\(2);
