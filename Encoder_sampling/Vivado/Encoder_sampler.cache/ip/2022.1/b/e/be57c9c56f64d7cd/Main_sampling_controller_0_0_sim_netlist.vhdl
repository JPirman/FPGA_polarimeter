...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sampling_controller is
  ...
  signal cpos_reg : STD_LOGIC_VECTOR ( 10 to 10 );
  ...
  attribute SOFT_HLUTNM of \cpos[10]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \cpos[9]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \cpos[9]_i_4\ : label is "soft_lutpair1";
begin
...
\cpos[9]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8F"
    )
        port map (
...
\cpos[9]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\cpos[9]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\cpos[9]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^cpos_o\ : STD_LOGIC_VECTOR ( 9 downto 0 );
...
begin
  ...
  cpos_o(9 downto 0) <= \^cpos_o\(9 downto 0);
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sampling_controller
     port map (
      D(9 downto 0) => \^cpos_o\(9 downto 0),
