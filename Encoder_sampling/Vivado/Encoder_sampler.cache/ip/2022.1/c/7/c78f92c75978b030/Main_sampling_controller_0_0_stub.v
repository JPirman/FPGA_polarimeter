...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(fpga_clk_i, reset_n_i, data_ready_o, trigger_i, 
  bram_addr, bram_clk, bram_wrdata, bram_rddata, bram_en, bram_we, idle_o, adc_data_ready_i, 
  adc_data_1, adc_data_2, enc_cnt_i)
/* synthesis syn_black_box black_box_pad_pin="fpga_clk_i,reset_n_i,data_ready_o,trigger_i,bram_addr[31:0],bram_clk,bram_wrdata[31:0],bram_rddata[31:0],bram_en,bram_we[3:0],idle_o,adc_data_ready_i,adc_data_1[15:0],adc_data_2[15:0],enc_cnt_i[10:0]" */;
  input fpga_clk_i;
  input reset_n_i;
  output data_ready_o;
  input trigger_i;
