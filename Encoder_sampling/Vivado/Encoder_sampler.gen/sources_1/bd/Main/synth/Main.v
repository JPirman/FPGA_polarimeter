...
module Encoder_imp_13XH5OO
  ...
  wire A_debouncer_signal_out;
  wire B_debouncer_signal_out;
  wire [10:0]Encoder_decoder_0_cnt_o;
  wire Encoder_decoder_0_dir_o;
  wire I_debouncer_signal_out;
  wire clk_0_1;
  wire nres_i_0_1;
  wire signal_in_0_1;
  wire signal_in_1_1;
  ...
  assign A_o = B_debouncer_signal_out;
  assign B_o = I_debouncer_signal_out;
  assign clk_0_1 = clk;
  assign cnt_o[10:0] = Encoder_decoder_0_cnt_o;
  assign dir_o_0 = Encoder_decoder_0_dir_o;
  assign nres_i_0_1 = nres;
  assign signal_in_0_1 = A_i;
  assign signal_in_1_1 = B_i;
  assign signal_in_2_1 = I_i;
  Main_Input_debouncer_0_4 A_debouncer
       (.clk(clk_0_1),
        .signal_in(signal_in_0_1),
        .signal_out(A_debouncer_signal_out));
  /* Encoders can produce
noisy signals. Therefore
a debouncer should be
used */
  Main_Input_debouncer_1_0 B_debouncer
       (.clk(clk_0_1),
        .signal_in(signal_in_1_1),
        .signal_out(B_debouncer_signal_out));
  Main_Encoder_decoder_0_0 Encoder_decoder_0
       (.A_i(A_debouncer_signal_out),
        .B_i(B_debouncer_signal_out),
        .I_i(I_debouncer_signal_out),
        .clk_i(clk_0_1),
        .cnt_o(Encoder_decoder_0_cnt_o),
        .dir_o(Encoder_decoder_0_dir_o),
        .nres_i(nres_i_0_1));
  Main_Input_debouncer_2_0 I_debouncer
       (.clk(clk_0_1),
        .signal_in(signal_in_2_1),
        .signal_out(I_debouncer_signal_out));
endmodule

(* CORE_GENERATION_INFO = "Main,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Main,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=29,numReposBlks=27,numNonXlnxBlks=0,numHierBlks=2,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=7,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=25,da_board_cnt=8,da_bram_cntlr_cnt=1,da_clkrst_cnt=3,da_mb_cnt=7,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Main.hwdef" *) 
module Main
   (A_i_0,
    BTN0,
    B_i_0,
...
mot_sby -  IO9 */
  ...
  wire [10:0]Encoder_cnt_o_0;
  wire Encoder_dir_o_0;
  wire Encoder_signal_out;
  wire Encoder_signal_out1;
  wire I_i_0_1;
  wire Input_debouncer_0_trigg_falling;
  wire SW0_1;
  wire adc_sdo_0_1;
  ...
  wire [31:0]sampling_controller_0_bram_addr;
  wire sampling_controller_0_bram_clk;
  wire sampling_controller_0_bram_en;
  wire [3:0]sampling_controller_0_bram_we;
  wire [31:0]sampling_controller_0_bram_wrdata;
  wire sampling_controller_0_idle_o;
  wire signal_in_0_1;
  wire sys_clock_1;
  ...
  assign LD2 = SW0_1;
  assign LD3 = Encoder_dir_o_0;
  assign LD4 = DSP_data_ready_o;
  assign LD5 = sampling_controller_0_idle_o;
  assign SW0_1 = SW0;
  ...
  Main_AD7983_driver_0_0 AD7983_driver_0
       (.adc_clk_i(clk_wiz_0_clk_out2),
        ...
        .reset_n_i(rst_clk_wiz_0_100M_peripheral_aresetn),
        .trigg_i(util_vector_logic_0_Res));
  Encoder_imp_13XH5OO Encoder
       (.A_i(A_i_0_1),
        .A_o(Encoder_signal_out),
        .B_i(B_i_0_1),
        .B_o(Encoder_signal_out1),
        .I_i(I_i_0_1),
        .clk(microblaze_0_Clk),
        .cnt_o(Encoder_cnt_o_0),
        .dir_o_0(Encoder_dir_o_0),
        .nres(rst_clk_wiz_0_100M_peripheral_aresetn));
  /* We can use the debouncer to
...
running when the button is held */
  Main_Input_debouncer_0_3 Input_debouncer_0
       (.clk(microblaze_0_Clk),
        .signal_in(signal_in_0_1),
        .trigg_falling(Input_debouncer_0_trigg_falling));
  (* BMM_INFO_ADDRESS_SPACE = "byte  0xC0000000 32 > Main axi_bram_ctrl_0_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Main_axi_bram_ctrl_0_1 axi_bram_ctrl_0
  ...
  Main_axi_bram_ctrl_0_bram_0 axi_bram_ctrl_0_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(sampling_controller_0_bram_addr),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(sampling_controller_0_bram_clk),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(sampling_controller_0_bram_wrdata),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(axi_bram_ctrl_0_bram_doutb),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(sampling_controller_0_bram_en),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(1'b0),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(sampling_controller_0_bram_we));
  Main_axi_gpio_0_1 axi_gpio_0
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > Main microblaze_0_local_memory/dlmb_bram_if_cntlr Main axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ...
  Main_sampling_controller_0_0 sampling_controller_0
       (.adc_data_1(AD7983_driver_0_data_o),
        .adc_data_2(xlconstant_0_dout),
        .adc_data_ready_i(AD7983_driver_0_data_rd_ready_o),
        .bram_addr(sampling_controller_0_bram_addr),
        .bram_clk(sampling_controller_0_bram_clk),
        .bram_en(sampling_controller_0_bram_en),
        .bram_rddata(axi_bram_ctrl_0_bram_doutb),
        .bram_we(sampling_controller_0_bram_we),
        .bram_wrdata(sampling_controller_0_bram_wrdata),
        .data_ready_o(DSP_data_ready_o),
        .enc_cnt_i(Encoder_cnt_o_0),
        .fpga_clk_i(microblaze_0_Clk),
        .idle_o(sampling_controller_0_idle_o),
        .reset_n_i(rst_clk_wiz_0_100M_peripheral_aresetn),
        .trigger_i(Input_debouncer_0_trigg_falling));
  /* Output of the XOR gate on bot
...
step. We'll use this to trigger the ADC */
  Main_util_vector_logic_0_1 util_vector_logic_0
       (.Op1(Encoder_signal_out),
        .Op2(Encoder_signal_out1),
