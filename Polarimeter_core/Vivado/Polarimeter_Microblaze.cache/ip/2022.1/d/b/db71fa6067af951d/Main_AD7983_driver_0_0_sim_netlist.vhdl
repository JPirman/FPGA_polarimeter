...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AD7983_driver is
  ...
  signal \adc_state[1]_i_1_n_0\ : STD_LOGIC;
  ...
  signal data_rd_ready_o_i_2_n_0 : STD_LOGIC;
  signal idle_state_del : STD_LOGIC;
  signal idle_state_del_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \adc_state[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \adc_state[3]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \adc_state[3]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \adc_state[3]_i_5\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \adc_state[3]_i_6\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \adc_tcnv_cnt[6]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of data_rd_ready_o_i_2 : label is "soft_lutpair6";
...
data_rd_ready_o_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => adc_state_reg(0),
      I2 => adc_state_reg(1),
      I3 => data_rd_ready_o_i_2_n_0,
      I4 => reset_n_i,
      I5 => \^data_rd_ready_o\,
      O => data_rd_ready_o_i_1_n_0
    );
data_rd_ready_o_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
idle_state_del_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => reset_n_i,
      I5 => idle_state_del,
      O => idle_state_del_i_1_n_0
    );
idle_state_del_reg: unisim.vcomponents.FDRE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => idle_state_del_i_1_n_0,
      Q => idle_state_del,
      R => '0'
    );
