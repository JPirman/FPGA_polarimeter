...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AD7983_driver is
  ...
  signal data_rd_ready_o_i_3_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of data_rd_ready_o_i_3 : label is "soft_lutpair1";
...
adc_clk_en_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01100010"
    )
        port map (
...
data_rd_ready_o_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0400FFFF04000000"
        ...
        port map (
      I0 => data_rd_ready_o_i_2_n_0,
      I1 => adc_state_reg(0),
      I2 => adc_state_reg(1),
      I3 => data_rd_ready_o_i_3_n_0,
      I4 => reset_n_i,
      I5 => \^data_rd_ready_o\,
...
data_rd_ready_o_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
