...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_DSP_controller is
  port (
    ...
    m0_axis_phase_tdata : out STD_LOGIC_VECTOR ( 10 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_DSP_controller is
  ...
  signal \cphase[10]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \cpos[2]_i_1_n_0\ : STD_LOGIC;
  signal \cpos[5]_i_1_n_0\ : STD_LOGIC;
  signal \cpos[8]_i_1_n_0\ : STD_LOGIC;
  ...
  signal madd_wait_state_reg_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \cpos[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cpos[7]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \cpos[8]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \cpos[9]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \res_0f[31]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \res_0f[31]_i_3\ : label is "soft_lutpair4";
begin
...
\cphase[10]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"08800000"
    )
        port map (
      ...
      I3 => encoder_cnt_i(0),
      I4 => nres_i,
      O => \cphase[10]_i_1_n_0\
    );
\cphase_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => fpga_clk_i,
      CE => \cphase[10]_i_1_n_0\,
      D => cpos_reg(0),
...
\cpos[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"9A"
    )
        port map (
...
\cpos[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A6AA"
    )
        port map (
...
\cpos[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
data_ready_o_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => cpos0,
      I1 => idle,
      I2 => data_ready_o_i_2_n_0,
      I3 => nres_i,
      I4 => \^data_ready_o\,
      I5 => \res_0f[31]_i_1_n_0\,
...
\madd_sin1f_c[47]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\madd_wait_cnt[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CCCC31DD00000000"
    )
        port map (
      I0 => \madd_wait_cnt[1]_i_2_n_0\,
      I1 => \madd_wait_cnt_reg_n_0_[0]\,
...
\madd_wait_cnt[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0F0C1F500000000"
    )
        port map (
      I0 => \madd_wait_cnt[1]_i_2_n_0\,
      I1 => \madd_wait_cnt_reg_n_0_[0]\,
...
madd_wait_state_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
      I0 => \madd_sin1f_c[47]_i_2_n_0\,
...
\res_0f[31]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00020200"
        ...
        port map (
      I0 => \res_0f[31]_i_2_n_0\,
      I1 => \res_0f[31]_i_3_n_0\,
      I2 => \res_0f[31]_i_4_n_0\,
      I3 => cnt_lsb_del,
      I4 => encoder_cnt_i(0),
      O => \res_0f[31]_i_1_n_0\
    );
\res_0f[31]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000008"
    )
        port map (
...
\res_0f[31]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^m0_axis_phase_tdata\ : STD_LOGIC_VECTOR ( 10 to 10 );
...
begin
  ...
  m0_axis_phase_tdata(10) <= \^m0_axis_phase_tdata\(10);
