...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AD7983_driver is
  ...
  signal \adc_tcnv_cnt[6]_i_3_n_0\ : STD_LOGIC;
  signal adc_tcnv_cnt_reg : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal adc_tcycle_cnt : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal adc_tcycle_cnt0 : STD_LOGIC_VECTOR ( 5 downto 0 );
  ...
  signal \adc_tcycle_cnt[5]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of adc_clk_en_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \adc_next_state_inferred__2/i_\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \adc_state[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \adc_state[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \adc_state[3]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \adc_state[3]_i_5\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \adc_tcnv_cnt[1]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \adc_tcnv_cnt[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \adc_tcnv_cnt[6]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \adc_tcycle_cnt[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \adc_tcycle_cnt[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \adc_tcycle_cnt[3]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \adc_tcycle_cnt[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \sclk_clk_cnt[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \sclk_clk_cnt[1]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \sclk_clk_cnt[4]_i_2\ : label is "soft_lutpair2";
begin
  adc_cnv_o <= \^adc_cnv_o\;
...
\adc_state[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFDDFD"
    )
        port map (
      ...
      I2 => adc_state_reg(0),
      I3 => \adc_tcycle_cnt[5]_i_2_n_0\,
      I4 => \adc_state[3]_i_5_n_0\,
...
\adc_tcnv_cnt[6]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      O => \adc_tcnv_cnt[6]_i_3_n_0\
    );
\adc_tcnv_cnt_reg[0]\: unisim.vcomponents.FDSE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => adc_tcnv_cnt0(0),
...
\adc_tcnv_cnt_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => adc_tcnv_cnt0(1),
...
\adc_tcnv_cnt_reg[2]\: unisim.vcomponents.FDSE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => adc_tcnv_cnt0(2),
...
\adc_tcnv_cnt_reg[3]\: unisim.vcomponents.FDSE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => adc_tcnv_cnt0(3),
...
\adc_tcnv_cnt_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => adc_tcnv_cnt0(4),
...
\adc_tcycle_cnt[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\adc_tcycle_cnt[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AE5E0000"
    )
        port map (
      I0 => adc_tcycle_cnt(1),
      I1 => \adc_next_state__0\(1),
      I2 => \adc_tcycle_cnt[5]_i_2_n_0\,
      I3 => adc_tcycle_cnt(0),
      I4 => reset_n_i,
      O => \adc_tcycle_cnt[1]_i_1_n_0\
    );
\adc_tcycle_cnt[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A9"
    )
        port map (
...
\adc_tcycle_cnt[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAAA9"
    )
        port map (
...
\adc_tcycle_cnt[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\adc_tcycle_cnt[5]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \adc_tcycle_cnt[5]_i_4_n_0\,
      I1 => adc_tcycle_cnt(6),
      O => \adc_tcycle_cnt[5]_i_2_n_0\
    );
\adc_tcycle_cnt[5]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAAAAA9"
    )
        port map (
...
\adc_tcycle_cnt[5]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      ...
      I4 => adc_tcycle_cnt(3),
      I5 => adc_tcycle_cnt(5),
      O => \adc_tcycle_cnt[5]_i_4_n_0\
    );
\adc_tcycle_cnt[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"C200"
    )
        port map (
      I0 => \adc_next_state__0\(1),
      I1 => adc_tcycle_cnt(6),
      I2 => \adc_tcycle_cnt[5]_i_4_n_0\,
      I3 => reset_n_i,
...
\adc_tcycle_cnt_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => fpga_clk_i,
      CE => \adc_tcycle_cnt[5]_i_2_n_0\,
      D => adc_tcycle_cnt0(0),
      Q => adc_tcycle_cnt(0),
      R => \adc_tcycle_cnt[5]_i_1_n_0\
    );
