...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AD7983_driver is
  ...
  signal data_tready_cnt0 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \data_tready_cnt[1]_i_1_n_0\ : STD_LOGIC;
  signal \data_tready_cnt[1]_i_2_n_0\ : STD_LOGIC;
  signal \data_tready_cnt[1]_i_3_n_0\ : STD_LOGIC;
  signal data_tready_cnt_reg : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  signal \sclk_clk_cnt[4]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \data_tready_cnt[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_tready_cnt[1]_i_3\ : label is "soft_lutpair9";
...
\data_tready_cnt[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => data_tready_cnt_reg(0),
      I1 => data_tready_cnt_reg(1),
      O => \data_tready_cnt[1]_i_2_n_0\
    );
\data_tready_cnt[1]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
