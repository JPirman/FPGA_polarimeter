...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AD7983_driver is
  ...
  signal data_rd_ready_o3_in : STD_LOGIC;
  signal data_rd_ready_o_i_1_n_0 : STD_LOGIC;
  signal \data_tready_cnt[0]_i_1_n_0\ : STD_LOGIC;
  signal \data_tready_cnt[1]_i_1_n_0\ : STD_LOGIC;
  signal \data_tready_cnt_reg_n_0_[0]\ : STD_LOGIC;
  signal \data_tready_cnt_reg_n_0_[1]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \adc_next_state_inferred__1/i_\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of adc_sclk_o_INST_0 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \adc_state[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \adc_state[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \adc_state[3]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \adc_state[3]_i_4\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \adc_state[3]_i_5\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \adc_state[3]_i_6\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \adc_tcnv_cnt[6]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of data_rd_ready_o_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \data_tready_cnt[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \data_tready_cnt[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \sclk_clk_cnt[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sclk_clk_cnt[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sclk_clk_cnt[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \sclk_clk_cnt[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \sclk_clk_cnt[4]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of tg_prev_state_i_1 : label is "soft_lutpair9";
begin
  adc_cnv_o <= \^adc_cnv_o\;
...
data_rd_ready_o_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F0F0EEF0"
    )
        port map (
      I0 => \data_tready_cnt_reg_n_0_[0]\,
      I1 => \data_tready_cnt_reg_n_0_[1]\,
      I2 => \^data_rd_ready_o\,
      I3 => reset_n_i,
      I4 => adc_clk_en,
...
\data_tready_cnt[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BA00"
    )
        port map (
      I0 => adc_clk_en,
      I1 => \data_tready_cnt_reg_n_0_[0]\,
      I2 => \data_tready_cnt_reg_n_0_[1]\,
      I3 => reset_n_i,
      O => \data_tready_cnt[0]_i_1_n_0\
    );
\data_tready_cnt[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EA00"
    )
        port map (
      ...
      I2 => \data_tready_cnt_reg_n_0_[1]\,
      I3 => reset_n_i,
      O => \data_tready_cnt[1]_i_1_n_0\
    );
\data_tready_cnt_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => \data_tready_cnt[0]_i_1_n_0\,
      Q => \data_tready_cnt_reg_n_0_[0]\,
      R => '0'
    );
\data_tready_cnt_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => \data_tready_cnt[1]_i_1_n_0\,
      Q => \data_tready_cnt_reg_n_0_[1]\,
      R => '0'
    );
