...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_DSP_controller is
  ...
  signal \cpos[9]_i_1_n_0\ : STD_LOGIC;
  signal \cpos[9]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \res_0f[31]_i_5_n_0\ : STD_LOGIC;
  signal \NLW_cpos0_inferred__0/i__carry_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \cpos[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cpos[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cpos[2]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \res_0f[31]_i_4\ : label is "soft_lutpair2";
begin
...
\cpos[9]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0880"
    )
        port map (
...
\cpos[9]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\madd_sin1f_b[15]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => s1_axis_data_tvalid,
      I5 => s0_axis_data_tvalid,
...
\madd_sin1f_c[47]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0002"
        ...
        port map (
      I0 => madd_wait_state_reg_n_0,
      I1 => \madd_wait_cnt_reg_n_0_[1]\,
      I2 => \madd_wait_cnt_reg_n_0_[0]\,
      I3 => idle,
...
\res_0f[31]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \res_0f[31]_i_5_n_0\,
      O => \res_0f[31]_i_1_n_0\
    );
\res_0f[31]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\res_0f[31]_i_5\: unisim.vcomponents.LUT6
    generic map(
