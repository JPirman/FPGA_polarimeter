...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Encoder_decoder is
  ...
  signal \cnt_reg[9]_i_2_n_7\ : STD_LOGIC;
  signal rdy_i_1_n_0 : STD_LOGIC;
  signal \^rdy_o\ : STD_LOGIC;
  signal \NLW_cnt_reg[9]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_cnt_reg[9]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute ADDER_THRESHOLD of \cnt_reg[9]_i_2\ : label is 35;
  attribute METHODOLOGY_DRC_VIOS of \cnt_reg[9]_i_2\ : label is "{SYNTH-8 {cell *THIS*}}";
...
\cnt_reg[9]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk_i,
      CE => \cnt_en__0\,
      D => \cnt_reg[9]_i_2_n_7\,
      Q => \^cnt_o\(9),
      R => \cnt[9]_i_1_n_0\
    );
\cnt_reg[9]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \cnt_reg[8]_i_1_n_0\,
      CO(3 downto 0) => \NLW_cnt_reg[9]_i_2_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_cnt_reg[9]_i_2_O_UNCONNECTED\(3 downto 1),
      O(0) => \cnt_reg[9]_i_2_n_7\,
      S(3 downto 1) => B"000",
      S(0) => \cnt[9]_i_3_n_0\
    );
