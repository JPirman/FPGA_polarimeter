...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AD7983_driver is
  ...
  signal \data_ready_flag__0\ : STD_LOGIC;
  signal data_ready_flag_reg_i_2_n_0 : STD_LOGIC;
  signal data_ready_flag_reg_i_3_n_0 : STD_LOGIC;
  signal data_tready_cnt0 : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \data_tready_cnt[3]_i_1_n_0\ : STD_LOGIC;
  signal data_tready_cnt_reg : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of adc_clk_en_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \adc_state[1]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \adc_state[3]_i_5\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \adc_tcnv_cnt[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \adc_tcnv_cnt[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \adc_tcnv_cnt[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \adc_tcnv_cnt[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \adc_tcnv_cnt[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of data_rd_ready_o_i_1 : label is "soft_lutpair8";
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of data_ready_flag_reg : label is "LDC";
  attribute XILINX_TRANSFORM_PINMAP : string;
  attribute XILINX_TRANSFORM_PINMAP of data_ready_flag_reg : label is "VCC:GE";
  attribute SOFT_HLUTNM of data_ready_flag_reg_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of data_ready_flag_reg_i_3 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data_tready_cnt[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_tready_cnt[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_tready_cnt[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_tready_cnt[3]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \sclk_clk_cnt[1]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of tg_prev_state_i_1 : label is "soft_lutpair8";
begin
  adc_cnv_o <= \^adc_cnv_o\;
...
\adc_next_state_inferred__1/i_\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FEF9FEFBFEFBFEF9"
    )
        port map (
      I0 => adc_state_reg(0),
      I1 => adc_state_reg(1),
...
\adc_state[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \adc_state[3]_i_4_n_0\,
      I2 => \adc_state[3]_i_5_n_0\,
      I3 => adc_state_reg(1),
      I4 => adc_tcnv_cnt_reg(6),
      I5 => \adc_state[3]_i_6_n_0\,
...
\adc_state[3]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => sclk_clk_cnt_reg(0),
      O => \adc_state[3]_i_4_n_0\
    );
\adc_state[3]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\adc_state[3]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\adc_tcnv_cnt[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFE00000001"
    )
        port map (
...
data_rd_ready_o_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
data_ready_flag_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
      CLR => data_ready_flag_reg_i_2_n_0,
      D => '1',
      G => \data_ready_flag__0\,
      GE => '1',
      Q => data_ready_flag
    );
data_ready_flag_reg_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00020000"
    )
        port map (
      ...
      I2 => adc_state_reg(0),
      I3 => adc_state_reg(1),
      I4 => data_ready_flag_reg_i_3_n_0,
      O => \data_ready_flag__0\
    );
data_ready_flag_reg_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
      I0 => data_tready_cnt_reg(0),
      I1 => data_tready_cnt_reg(1),
      I2 => data_tready_cnt_reg(2),
      I3 => data_tready_cnt_reg(3),
      I4 => data_ready_flag_reg_i_3_n_0,
      O => data_ready_flag_reg_i_2_n_0
    );
data_ready_flag_reg_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000002"
    )
        port map (
      ...
      O => data_ready_flag_reg_i_3_n_0
    );
\data_tready_cnt[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => data_tready_cnt_reg(0),
      O => data_tready_cnt0(0)
    );
\data_tready_cnt[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
      I0 => data_tready_cnt_reg(1),
      I1 => data_tready_cnt_reg(0),
      O => data_tready_cnt0(1)
    );
\data_tready_cnt[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E1"
    )
        port map (
      ...
      I1 => data_tready_cnt_reg(0),
      I2 => data_tready_cnt_reg(2),
      O => data_tready_cnt0(2)
    );
\data_tready_cnt[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => reset_n_i,
      I1 => data_ready_flag,
      O => \data_tready_cnt[3]_i_1_n_0\
    );
\data_tready_cnt[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE01"
    )
        port map (
      I0 => data_tready_cnt_reg(2),
      I1 => data_tready_cnt_reg(0),
      I2 => data_tready_cnt_reg(1),
      I3 => data_tready_cnt_reg(3),
      O => data_tready_cnt0(3)
    );
\data_tready_cnt_reg[0]\: unisim.vcomponents.FDSE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => data_tready_cnt0(0),
      Q => data_tready_cnt_reg(0),
      S => \data_tready_cnt[3]_i_1_n_0\
    );
\data_tready_cnt_reg[1]\: unisim.vcomponents.FDSE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => data_tready_cnt0(1),
      Q => data_tready_cnt_reg(1),
      S => \data_tready_cnt[3]_i_1_n_0\
    );
\data_tready_cnt_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => data_tready_cnt0(2),
      Q => data_tready_cnt_reg(2),
      R => \data_tready_cnt[3]_i_1_n_0\
    );
\data_tready_cnt_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => fpga_clk_i,
      CE => '1',
      D => data_tready_cnt0(3),
      Q => data_tready_cnt_reg(3),
      R => \data_tready_cnt[3]_i_1_n_0\
    );
