...
module DSP_imp_XOOWFH
  ...
  wire CLK_1;
  wire [15:0]DSP_controller_0_adc_data;
  wire [31:0]DSP_controller_0_add_b;
  wire DSP_controller_0_data_ready_o;
  wire [15:0]DSP_controller_0_m0_axis_phase_TDATA;
  wire DSP_controller_0_m0_axis_phase_TVALID;
  wire [15:0]DSP_controller_0_m1_axis_phase_TDATA;
  wire DSP_controller_0_m1_axis_phase_TVALID;
  wire [15:0]DSP_controller_0_madd_cos1f_b;
  wire [47:0]DSP_controller_0_madd_cos1f_c;
  wire [15:0]DSP_controller_0_madd_cos2f_b;
  wire [47:0]DSP_controller_0_madd_cos2f_c;
  wire [15:0]DSP_controller_0_madd_sin1f_b;
  wire [47:0]DSP_controller_0_madd_sin1f_c;
  wire [15:0]DSP_controller_0_madd_sin2f_b;
  wire [47:0]DSP_controller_0_madd_sin2f_c;
  wire [31:0]DSP_controller_0_res_0f;
  wire [47:0]DSP_controller_0_res_cos1f;
  wire [47:0]DSP_controller_0_res_cos2f;
  wire [47:0]DSP_controller_0_res_sin1f;
  wire [47:0]DSP_controller_0_res_sin2f;
  wire [15:0]adc_data_i_1;
  wire adc_data_ready_i_1;
  ...
  wire [10:0]encoder_cnt_i_1;
  wire reset_1;
  wire [47:0]xbip_multadd_0_P;
  wire [47:0]xbip_multadd_1_P;
  wire [47:0]xbip_multadd_2_P;
  wire [47:0]xbip_multadd_3_P;
  wire [0:0]xlconstant_0_dout;
  wire [0:0]xlconstant_1_dout;

  assign CLK_1 = CLK;
  assign adc_data_i_1 = adc_data_i[15:0];
  assign adc_data_ready_i_1 = adc_data_ready_i;
  assign data_ready_o = DSP_controller_0_data_ready_o;
  assign encoder_cnt_i_1 = encoder_cnt_i[10:0];
  assign res_0f[31:0] = DSP_controller_0_res_0f;
  assign res_cos1f[47:0] = DSP_controller_0_res_cos1f;
  assign res_cos2f[47:0] = DSP_controller_0_res_cos2f;
  assign res_sin1f[47:0] = DSP_controller_0_res_sin1f;
  assign res_sin2f[47:0] = DSP_controller_0_res_sin2f;
  assign reset_1 = reset;
  Main_DSP_controller_0_1 DSP_controller_0
       (.adc_data(DSP_controller_0_adc_data),
        .adc_data_i(adc_data_i_1),
        .adc_data_ready_i(adc_data_ready_i_1),
        .add_b(DSP_controller_0_add_b),
        .add_s(c_addsub_0_S),
        .data_ready_o(DSP_controller_0_data_ready_o),
        .encoder_cnt_i(encoder_cnt_i_1),
        .fpga_clk_i(CLK_1),
        .m0_axis_phase_tdata(DSP_controller_0_m0_axis_phase_TDATA),
        .m0_axis_phase_tvalid(DSP_controller_0_m0_axis_phase_TVALID),
        .m1_axis_phase_tdata(DSP_controller_0_m1_axis_phase_TDATA),
        .m1_axis_phase_tvalid(DSP_controller_0_m1_axis_phase_TVALID),
        .madd_cos1f_b(DSP_controller_0_madd_cos1f_b),
        .madd_cos1f_c(DSP_controller_0_madd_cos1f_c),
        .madd_cos1f_p(xbip_multadd_1_P),
        .madd_cos2f_b(DSP_controller_0_madd_cos2f_b),
        .madd_cos2f_c(DSP_controller_0_madd_cos2f_c),
        .madd_cos2f_p(xbip_multadd_2_P),
        .madd_sin1f_b(DSP_controller_0_madd_sin1f_b),
        .madd_sin1f_c(DSP_controller_0_madd_sin1f_c),
        .madd_sin1f_p(xbip_multadd_0_P),
        .madd_sin2f_b(DSP_controller_0_madd_sin2f_b),
        .madd_sin2f_c(DSP_controller_0_madd_sin2f_c),
        .madd_sin2f_p(xbip_multadd_3_P),
        .nres_i(reset_1),
        .res_0f(DSP_controller_0_res_0f),
        .res_cos1f(DSP_controller_0_res_cos1f),
        .res_cos2f(DSP_controller_0_res_cos2f),
        .res_sin1f(DSP_controller_0_res_sin1f),
        .res_sin2f(DSP_controller_0_res_sin2f),
        .s0_axis_data_tdata(dds_compiler_0_M_AXIS_DATA_TDATA),
        .s0_axis_data_tvalid(dds_compiler_0_M_AXIS_DATA_TVALID),
        .s1_axis_data_tdata(dds_compiler_1_M_AXIS_DATA_TDATA),
        .s1_axis_data_tvalid(dds_compiler_1_M_AXIS_DATA_TVALID));
  Main_c_addsub_0_0 c_addsub_0
       (.A(DSP_controller_0_adc_data),
        .B(DSP_controller_0_add_b),
        .CLK(CLK_1),
        .S(c_addsub_0_S));
  Main_dds_compiler_0_0 dds_compiler_0
       (.aclk(CLK_1),
        .m_axis_data_tdata(dds_compiler_0_M_AXIS_DATA_TDATA),
        .m_axis_data_tvalid(dds_compiler_0_M_AXIS_DATA_TVALID),
        .s_axis_phase_tdata(DSP_controller_0_m0_axis_phase_TDATA),
        .s_axis_phase_tvalid(DSP_controller_0_m0_axis_phase_TVALID));
  Main_dds_compiler_0_1 dds_compiler_1
       (.aclk(CLK_1),
        .m_axis_data_tdata(dds_compiler_1_M_AXIS_DATA_TDATA),
        .m_axis_data_tvalid(dds_compiler_1_M_AXIS_DATA_TVALID),
        .s_axis_phase_tdata(DSP_controller_0_m1_axis_phase_TDATA),
        .s_axis_phase_tvalid(DSP_controller_0_m1_axis_phase_TVALID));
  Main_xbip_multadd_0_1 xbip_multadd_0
       (.A(DSP_controller_0_adc_data),
        .B(DSP_controller_0_madd_sin1f_b),
        .C(DSP_controller_0_madd_sin1f_c),
        .CE(xlconstant_1_dout),
        .CLK(CLK_1),
        .P(xbip_multadd_0_P),
        .SCLR(1'b0),
        .SUBTRACT(xlconstant_0_dout));
  Main_xbip_multadd_0_5 xbip_multadd_1
       (.A(DSP_controller_0_adc_data),
        .B(DSP_controller_0_madd_cos1f_b),
        .C(DSP_controller_0_madd_cos1f_c),
        .CE(xlconstant_1_dout),
        .CLK(CLK_1),
        .P(xbip_multadd_1_P),
        .SCLR(1'b0),
        .SUBTRACT(xlconstant_0_dout));
  Main_xbip_multadd_0_6 xbip_multadd_2
       (.A(DSP_controller_0_adc_data),
        .B(DSP_controller_0_madd_cos2f_b),
        .C(DSP_controller_0_madd_cos2f_c),
        .CE(xlconstant_1_dout),
        .CLK(CLK_1),
        .P(xbip_multadd_2_P),
        .SCLR(1'b0),
        .SUBTRACT(xlconstant_0_dout));
  Main_xbip_multadd_0_7 xbip_multadd_3
       (.A(DSP_controller_0_adc_data),
        .B(DSP_controller_0_madd_sin2f_b),
        .C(DSP_controller_0_madd_sin2f_c),
        .CE(xlconstant_1_dout),
        .CLK(CLK_1),
        .P(xbip_multadd_3_P),
        .SCLR(1'b0),
        .SUBTRACT(xlconstant_0_dout));
  Main_xlconstant_0_1 xlconstant_0
       (.dout(xlconstant_0_dout));
  Main_xlconstant_0_2 xlconstant_1
       (.dout(xlconstant_1_dout));
endmodule

module Encoder_imp_13XH5OO
   (A_i,
    A_o,
    B_i,
    B_o,
  ...
  wire A_i_0_1;
  wire B_i_0_1;
  wire [10:0]Encoder_decoder_0_cnt_o;
  wire Encoder_decoder_0_dir_o;
  wire I_i_0_1;
  wire Input_debouncer_0_out;
  wire Input_debouncer_1_out;
  wire Input_debouncer_2_out;
  wire clk_1;
  wire nres_i_1;

  assign A_i_0_1 = A_i;
  assign A_o = Input_debouncer_0_out;
  assign B_i_0_1 = B_i;
  assign B_o = Input_debouncer_1_out;
  assign I_i_0_1 = I_i;
  assign clk_1 = clk;
  assign cnt_o[10:0] = Encoder_decoder_0_cnt_o;
  assign dir_o = Encoder_decoder_0_dir_o;
  assign nres_i_1 = nres;
  Main_Encoder_decoder_0_0 Encoder_decoder_0
       (.A_i(Input_debouncer_0_out),
        .B_i(Input_debouncer_1_out),
        .I_i(Input_debouncer_2_out),
        .clk_i(clk_1),
        .cnt_o(Encoder_decoder_0_cnt_o),
        .dir_o(Encoder_decoder_0_dir_o),
        .nres_i(nres_i_1));
  Main_Input_debouncer_0_0 Input_debouncer_0
       (.clk(clk_1),
        .signal_in(A_i_0_1),
        .signal_out(Input_debouncer_0_out));
  Main_Input_debouncer_0_1 Input_debouncer_1
       (.clk(clk_1),
        .signal_in(B_i_0_1),
        .signal_out(Input_debouncer_1_out));
  Main_Input_debouncer_0_2 Input_debouncer_2
       (.clk(clk_1),
        .signal_in(I_i_0_1),
        .signal_out(Input_debouncer_2_out));
endmodule

(* CORE_GENERATION_INFO = "Main,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Main,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=42,numReposBlks=32,numNonXlnxBlks=0,numHierBlks=10,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=7,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=22,da_board_cnt=8,da_clkrst_cnt=3,da_mb_cnt=7,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Main.hwdef" *) 
module Main
   (A_i_0,
    B_i_0,
    I_i_0,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN Main_sys_clock, FREQ_HZ 12000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 usb_uart RxD" *) input usb_uart_rxd;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 usb_uart TxD" *) output usb_uart_txd;

  wire AD7983_driver_0_adc_cnv;
  wire AD7983_driver_0_adc_sck;
  wire [15:0]AD7983_driver_0_data_o;
  wire AD7983_driver_0_data_rd_ready_o;
  wire A_i_0_1;
  wire B_i_0_1;
  wire DSP_data_ready_o;
  wire [31:0]DSP_res_0f;
  wire [47:0]DSP_res_cos1f;
  wire [47:0]DSP_res_cos2f;
  wire [47:0]DSP_res_sin1f;
  wire [47:0]DSP_res_sin2f;
  wire Encoder_dir_o_0;
  wire I_i_0_1;
  wire Input_debouncer_0_out;
  wire Input_debouncer_1_out;
  wire SW0_1;
  ...
  assign A_i_0_1 = A_i_0;
  assign B_i_0_1 = B_i_0;
  assign I_i_0_1 = I_i_0;
  assign SW0_1 = SW0;
  assign adc_cnv_0 = AD7983_driver_0_adc_cnv;
  assign adc_sck_0 = AD7983_driver_0_adc_sck;
  assign adc_sdo_0_1 = adc_sdo_0;
  ...
  assign dir_o_0 = Encoder_dir_o_0;
  ...
  assign mot_dir = SW0_1;
  assign mot_sby = SW0_1;
  assign reset_1 = reset;
  ...
  Main_AD7983_driver_0_0 AD7983_driver_0
       (.adc_clk_i(clk_wiz_0_clk_out2),
        .adc_cnv_o(AD7983_driver_0_adc_cnv),
        .adc_sclk_o(AD7983_driver_0_adc_sck),
        .adc_sdo(adc_sdo_0_1),
        .data_o(AD7983_driver_0_data_o),
        .data_rd_ready_o(AD7983_driver_0_data_rd_ready_o),
        .fpga_clk_i(microblaze_0_Clk),
        .reset_n_i(reset_1),
        .trigg_i(util_vector_logic_0_Res));
  Main_AXI_DSP_Register_0_0 AXI_DSP_Register_0
  ...
  DSP_imp_XOOWFH DSP
       (.CLK(microblaze_0_Clk),
        .adc_data_i(AD7983_driver_0_data_o),
        .adc_data_ready_i(AD7983_driver_0_data_rd_ready_o),
        .data_ready_o(DSP_data_ready_o),
        .encoder_cnt_i(encoder_cnt_i_1),
        .res_0f(DSP_res_0f),
        .res_cos1f(DSP_res_cos1f),
        .res_cos2f(DSP_res_cos2f),
        .res_sin1f(DSP_res_sin1f),
        .res_sin2f(DSP_res_sin2f),
        .reset(reset_1));
  Encoder_imp_13XH5OO Encoder
       (.A_i(A_i_0_1),
        .A_o(Input_debouncer_0_out),
        .B_i(B_i_0_1),
        .B_o(Input_debouncer_1_out),
        .I_i(I_i_0_1),
        .clk(microblaze_0_Clk),
        .cnt_o(encoder_cnt_i_1),
        .dir_o(Encoder_dir_o_0),
        .nres(rst_clk_wiz_0_100M_peripheral_aresetn));
  Main_axi_iic_0_1 axi_iic_0
       (.s_axi_aclk(microblaze_0_Clk),
  ...
  Main_axi_quad_spi_0_1 axi_quad_spi_0
  ...
  Main_axi_uartlite_0_2 axi_uartlite_0
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > Main microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Main_microblaze_0_3 microblaze_0
  ...
  Main_microblaze_0_axi_intc_3 microblaze_0_axi_intc
  ...
  Main_microblaze_0_axi_periph_4 microblaze_0_axi_periph
  ...
  microblaze_0_local_memory_imp_2C4IQC microblaze_0_local_memory
  ...
  Main_microblaze_0_xlconcat_3 microblaze_0_xlconcat
       (.In0(axi_uartlite_0_interrupt),
        .In1(DSP_data_ready_o),
        .dout(microblaze_0_intr));
  Main_rst_clk_wiz_0_100M_1 rst_clk_wiz_0_100M
       (.aux_reset_in(1'b1),
  ...
  Main_util_vector_logic_0_1 util_vector_logic_0
       (.Op1(Input_debouncer_0_out),
        .Op2(Input_debouncer_1_out),
        .Res(util_vector_logic_0_Res));
endmodule

module Main_microblaze_0_axi_periph_4
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_1BI9D0W m00_couplers
  ...
  m01_couplers_imp_F1KP52 m01_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  m02_couplers_imp_KMJYQL m02_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  m03_couplers_imp_1NR2223 m03_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  m04_couplers_imp_1DJSG17 m04_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  s00_couplers_imp_UEXEYT s00_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
...
module m00_couplers_imp_1BI9D0W
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
module m01_couplers_imp_F1KP52
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m02_couplers_imp_KMJYQL
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m03_couplers_imp_1NR2223
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m04_couplers_imp_1DJSG17
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module microblaze_0_local_memory_imp_2C4IQC
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > Main microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Main_dlmb_bram_if_cntlr_4 dlmb_bram_if_cntlr
  ...
  Main_dlmb_v10_4 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  Main_ilmb_bram_if_cntlr_4 ilmb_bram_if_cntlr
...
module s00_couplers_imp_UEXEYT
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
