    ...
    begin
        if(reset_n_i == 1'b0)
            ...
            begin
                ...
                data_rd_ready_o <= (adc_state == ADC_IDLE_STATE)&&(sclk_clk_cnt == ADC_SCLK_PERIODS) ? 1 : 0;    //Delay data ready output by one clock cycle to prevent any clock domain bugs.
